...
This project aims to collect data from `2,000` Muslims each year.
...
4.    To to bring the Muslim community `closer to science`.
5.    To to `facilitate advocacy` for the Muslim community based on findings from this project.

### Sharing Findings

The findings from current project will be shared with the
Muslim community or a regular basis in the forms of brief reports, infographics, and scientific publications. In addition, the findings will be directly
shared with the government organisations in an attempt to influence key
decisions and policy for the good of Muslim community.
